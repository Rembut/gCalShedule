...
module.exports = function(app) {
  ...
  app.post('/api/specialities', [authJwt.verifyToken], specialities.create);
  ...
  app.put('/api/specialities/:id', [authJwt.verifyToken], specialities.update);

  // delete a specialitie by id
  app.delete('/api/specialities/:id', [authJwt.verifyToken], specialities.delete);
