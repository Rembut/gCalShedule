...
function listEvents(auth) {
  ...
  calendar.events.list({
    //calendarId: 'primary',
    calendarId: 'ahfc8k9ae5aahfj614omju7hks@group.calendar.google.com',
...
function deleteCalendar(auth) {
  const calendar = google.calendar({version: 'v3', auth});
  //console.log(calendar.calendars.insert);
  calendar.calendars.delete({calendarId: "4b7s0qklc6tdun6p8o1r2bsg7k@group.calendar.google.com"});
}
